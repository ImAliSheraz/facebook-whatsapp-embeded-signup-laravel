...
<head>
    ...
    <title>Facebook Whatsapp Integration</title>
    ...
    <script>
        window.fbAsyncInit = function() {
            ...
            FB.init({
                appId: "{{ config('services.meta.app_id') }}", // Facebook App ID
                cookie: true, // enable cookies
                xfbml: true, // parse social plugins on this page
                version: "{{ config('services.meta.api_version') }}" //Graph API version
            });
        };
        ...
        function launchWhatsAppSignup() {
            ...
            FB.login(function(response) {
                ...
                config_id: "{{ config('services.meta.config_id') }}", // configuration ID goes here
